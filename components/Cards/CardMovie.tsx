        ...
        <div className={styles.card}>
            <div className={styles.card_wrapper}>
                ...
                <div className={styles.card_wrapper__body}>
                    <p className={styles.card_wrapper__body_release_date}>
                        {release_date}
                    </p>
                    <h3 className={styles.card_wrapper__body_title}>
                        {title}
                    </h3>
                    ...
                    <p
                        className={styles.card_wrapper__body_genres}
                    >
                        {genre_ids.join(", ")}
                    </p>
                </div>
